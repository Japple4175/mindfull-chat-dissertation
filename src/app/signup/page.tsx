...
export default function SignupPage() {
  ...
  const handleSignup = async (e: FormEvent) => {
    ...
    try {
      ...
      toast({ title: 'Signup Successful', description: 'Welcome to Mindful Chat!' });
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-background to-primary/10 p-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Join Mindful Chat and start your wellness journey today.</CardDescription>
        </CardHeader>
        <CardContent>
